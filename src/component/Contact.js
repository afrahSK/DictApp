        ...
        Axios.post('http://localhost:3002/create',
            {
                ...
                console.log("success");
                alert("Thank you!Your response has been recorded.We will respond to it as soon as possible");
            }).catch((error) => {
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                            Feel free to reach out to us anytime. We're here to assist you.</p>
                    </div>
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <div className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                <button onClick={addRecord} className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                                    Submit</button>
                            </div>
                            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                <a className="text-indigo-500">dictapp@gmail.com</a>
                                <p className="leading-normal my-5">Dr.V.R.Godhaniya College,
                                    <br />Porbandar
                                </p>
                            </div>
                        </div>
